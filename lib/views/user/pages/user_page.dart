            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  title: Text(activeUser != null? '${activeUser.firstName} ${activeUser.lastName}'.trim() : 'User Full Name'),
                  subtitle: Text(activeUser?.username ?? 'Username'),
                ),
                Padding(
                  padding: const EdgeInsets.fromLTRB(largeSize, 0, largeSize, largeSize),
                  child: Row(
